...
public class User_Events {
    ...
    /**
     * @param TypeOther The Type_Other
     */
    @JsonProperty("Type_Other")
    ...
    /**
     * @param TypePlant The Type_Plant
     */
    @JsonProperty("Type_Plant")
    ...
    /**
     * @param TypeTrash The Type_Trash
     */
    @JsonProperty("Type_Trash")
    ...
    /**
     * @param TypeWater The Type_Water
     */
    @JsonProperty("Type_Water")
